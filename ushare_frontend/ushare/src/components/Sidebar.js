...
const Sidebar = ({user , closeToggle}) => {
  const isNotActiveStyle= 'flex items-center px-5 gap-3 text-grey-500 transition-all hover:text-black duration-100 ease-in-out capitalize'
  ...
  return (
    <div className='flex flex-col justify-between bg-white h-full overflow-y-scroll min-w-210 hide-scrollbar'>
      <div className='flex flex-col'>
         ...
         <h3 style={{fontFamily: `'Kanit', sans-serif`,fontSize : '1.5rem' , color:'white' , borderRadius:'0.3rem'}} className='px-5 p-1 m-2 bg-gradient-to-r from-purple-500 to-red-500'>Ushare</h3>
         </Link>
